...
%   \begin{itemize}
%   \item Grundlegendes Arbeiten mit \LaTeX\ (Dokumentenklassen, Präambel, \dots)
%   \item Textuelles Markup (\enquote{Alles, was Word so kann})
%   \item Grafiken und Bilder
%   \item Inhalts- und Literaturverzeichnis, Referenzieren
%   \end{itemize}
